...
data = genfromtxt("new_anni_events.dat", max_rows=num_of_neutrons)    #max_rows= limits rows
print("data loaded") 
ellipsoid = genfromtxt("WorkingEllipsoidConfigurations.dat", max_rows=num_of_ellipse)
print("ellipsoids loaded")

print("create file")
#Open the text file and erase it then close it
f = open("reflected_file.txt", "w+")
